...
Optionally, you can define a `fallback-description` that is shown to players on older client versions that don't support modern formatting. If this is not set, those players will just see the server's default MOTD.
